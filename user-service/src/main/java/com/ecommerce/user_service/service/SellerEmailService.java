...
public class SellerEmailService {
    ...
    public void sendApprovedEmail(String toEmail, String shopName) {
        try {
            ...
            msg.setTo(toEmail);
            msg.setSubject("CORE - Đơn đăng ký Seller đã được duyệt!");
            msg.setText("Xin chào,\n\n"
                    + "Chúc mừng! Đơn đăng ký mở shop \"" + shopName + "\" của bạn đã được CORE duyệt.\n\n"
    ...
    public void sendRejectedEmail(String toEmail, String shopName, String reason) {
        try {
            SimpleMailMessage msg = new SimpleMailMessage();
            msg.setTo(toEmail);
            msg.setSubject("CORE - Đơn đăng ký Seller chưa được chấp thuận");
            msg.setText("Xin chào,\n\n"
    ...
    public void sendRoleChangedToSellerEmail(String toEmail, String name) {
        try {
            SimpleMailMessage msg = new SimpleMailMessage();
            msg.setTo(toEmail);
            msg.setSubject("CORE - Tài khoản của bạn đã được nâng cấp lên Seller");
            msg.setText("Xin chào " + (name != null ? name : "") + ",\n\n"
                    + "Tài khoản CORE của bạn vừa được Admin nâng cấp lên vai trò Seller.\n\n"
    ...
    public void sendBankOtpEmail(String toEmail, String otp) {
        try {
            SimpleMailMessage msg = new SimpleMailMessage();
            msg.setTo(toEmail);
            msg.setSubject("CORE - OTP Xác Nhận Thêm Tài Khoản Ngân Hàng");
            msg.setText("Xin chào,\n\n"
    ...
    public void sendCreditCardOtpEmail(String toEmail, String otp) {
        try {
            SimpleMailMessage msg = new SimpleMailMessage();
            msg.setTo(toEmail);
            msg.setSubject("CORE - OTP Xác Nhận Thêm Thẻ Tín Dụng/Ghi Nợ");
            msg.setText("Xin chào,\n\n"
